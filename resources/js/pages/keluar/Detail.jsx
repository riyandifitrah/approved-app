...
const handleKembali = () => {
    history.push("/barang-keluar/data")
};

useEffect(() => {
    async function fetchData() {
        try {
        const res = await axios.get(`/api/transactions/keluar/detail/${nomtrans}`, {
...
const handleSubmit = async (e) => {
    e.preventDefault();
    try {
        const res = await axios.put(`/api/transactions/keluar/update/${nomtrans}`, form, {
        headers: { 
    ...
    <div className="container mt-5">
        <div className="card text-white mb-4 gradient-card">
            <div className="card-body text-center py-4">
                <h1 className="card-title mb-0"><i className="bi bi-file-earmark-medical"></i>&nbsp;Edit Barang Keluar</h1>
            </div>
        </div>
        <hr />
